...
// ============ Static Routes ============ 
// Will use: path 
app.use(express.static(path.join(__dirname, "Angular-Route-Tree/dist/Angular-Route-Tree"))); 
...
app.all("*", (req,res,next) => {
    res.sendFile(path.resolve("./Angular-Route-Tree/dist/Angular-Route-Tree/index.html"))
  });
